...
let blockArray = [];
let blockWidth = 50;
let blockHeight = 50; // Update height to match your image height
let blockColumns = 8; 
...
// Image array to store block images
let blockImages = [];

// Load images
for (let i = 0; i < 8; i++) { // Adjust number of images as per your need
    let img = new Image();
    img.src = `./`
    img.src = `./${1}.png`; // Update the path as per your project structure
    ...
    for (let c = 0; c < blockColumns; c++) {
        for (let r = 0; r < blockRows; r++) {
            let block = {
                ...
                height : blockHeight,
                break : false,
                image : blockImages[c % blockImages.length] // Cycle through images
            }
